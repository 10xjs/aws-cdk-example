            ...
            class S {
              constructor(e, r) {
                (this.session = c().create()),
                  ...
                  this.session.consult(':- use_module(library(js)).'),
              ...
              async *makeQuery(ee) {
                ...
                for (;;) {
                  ...
                  if ('throw' === e.id) {
                    console.log(require('util').inspect(e, false, 10, true));
                    throw k(e);
                  }
                  yield e;
                }
                ...
                i = (function (e, r) {
                  ...
                  return (
                    ...
                    (y = c.readFileSync(k, {encoding: e.encoding}).trim())
                      ...
                      : ((d = c.readFileSync(x, {encoding: e.encoding}).trim()),
            ...
            (r._DBG_set_useExt = function (e) {
              ...
              (r.keyInPause = function (e, t) {
                null == e && (e = 'Continue...'),
                  ...
                  r.keyIn(e, P({limit: null}, t, {hideEchoBack: !0, mask: ''}));
              }),
